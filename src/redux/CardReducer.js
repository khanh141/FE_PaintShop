  ...
  //     },
  //     increaseQuantity: (state, action) => {
  //       // Logic của increaseQuantity...
  //     },
  //     decreaseQuantity: (state, action) => {
  //       // Logic của decreaseQuantity...
  //     },
  //     removeProduct: (state, action) => {
  //       // Logic của removeProduct...
  //     },
  //     setSelectedItemsFromStorage: (state, action) => {
  //       const selectedItems = action.payload;
  //       state.products.forEach((product) => {
  //         const isSelected = selectedItems.some(
  //           (item) =>
  //             item.maSanPham === product.maSanPham &&
  //             item.mau === product.chiTietSanPham.mau &&
  //             item.loaiBaoBi === product.chiTietSanPham.loaiBaoBi
  //         );
  //         product.isChecked = isSelected;
  //       });
  //     },
  //   },
  //   extraReducers: (builder) => {
