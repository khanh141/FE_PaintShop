...
import { Container, Button, Row, Col, FloatingLabel, Form, Alert } from 'react-bootstrap';
      ...
      <Row className="mt-2 d-flex align-items-center justify-content-center">
        <Col md={6}>
          <div className="p-4 border rounded-3 shadow-sm authForm">  {/* Border wrapper */}
            ...
            {errors.matKhau && (
              <Alert className='mt-1' variant="danger">
                {translateError(errors.matKhau).map((translatedMsg, index) => (
            ...
            <Row className="g-2 nameAndphone mt-4">
              <Col md={6}>
                ...
                {errors.hoTen && errors.hoTen.includes('trong') && (
                  <Alert className='mt-1' variant="danger">
              ...
              <Col md={6}>
                ...
                {errors.sdt && (
                  <Alert className="mt-1" variant="danger">
                    {errors.sdt.includes('10') && 'Số điện thoại phải gồm 10 chữ số'}
                    {errors.sdt.includes('trong') && 'Số điện thoại không được để trống'}
      ...
      {/* <Row className="d-flex align-items-center justify-content-center">
        <Col md={6}>
          <div className="p-4 border rounded-3 shadow-sm">
            <h1 className="text-center fw-bold mb-3">Đăng Ký</h1>
            <Row className="g-2 nameAndphone">
              <Col md={6}>
                <FloatingLabel label="Họ và tên">
                  <Form.Control
                    type="text"
